...
WebUI.selectOptionByValue(findTestObject('1. CURA Object button/Facility'), facilityBook, true, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('1. CURA Object button/Visit Date'), visitDateBook)
